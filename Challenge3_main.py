# Challenge3_main.py - ESP32 MQTT Controlled LED
#
# This script is a controller that connects to Wi-Fi
...
# REPLACE with your actual unique name/identifier string.
MY_UNIQUE_IDENTIFIER = "youlikejazz?"

# Hardware Setup (Using Pin 2)
LED_PIN = 2
...
def sub_cb(topic, msg):
    ...
    #I think i got all the fixes here: 
    # 1. Decode to string.
    ...
    # The command should turn led "ON" or "OFF"
